...
export default function VocabDrill({ vocab, lessonId }) {
    ...
    const [coverStates, setCoverStates] = useState({});
    ...
    // Initialize cover states for all vocab words
    useEffect(() => {
        if (vocab && vocab.length > 0) {
            const initialCoverStates = {};
            vocab.forEach(word => {
                initialCoverStates[word.spanish] = {
                    spanishCovered: false,
                    chineseCovered: false
                };
            });
            setCoverStates(initialCoverStates);
        }
    }, [vocab]);
                        ...
                        {vocab.map((word) => {
                            ...
                            return (
                                ...
                                >
                                    {/* Spanish cell */}
                                    <div
                                        className="flex-1 relative p-3 cursor-pointer group hover:bg-yellow-100 transition-colors"
                                    ...
                                    >
                                        {cover.spanishCovered ? (
                                            ...
                                            <>
                                                ...
                                                <span className="font-bold text-lg text-slate-900">{word.spanish}</span>
                                            </>
                                        )}
                                    </div>
                                    ...
                                    {/* Chinese cell */}
                                    <div
                                        className="flex-1 relative p-3 cursor-pointer group hover:bg-red-100 transition-colors"
                                    ...
                                    >
                                        {cover.chineseCovered ? (
                                            ...
                                            <>
                                                ...
                                                <span className="font-medium text-lg text-slate-800">{word.chinese}</span>
                                            </>
                                        )}
                                    </div>
                                    <div className="w-px bg-slate-200"></div>
